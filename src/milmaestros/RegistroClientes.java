...
public class RegistroClientes extends JFrame implements ActionListener
{
   ConexionBD conn = new ConexionBD();
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            try {
                PreparedStatement ps = conn.crearConexion().prepareStatement("INSERT INTO cliente(nombre, apellidoPaterno, apellidoMaterno, rut, dv, direccion, comuna, region, telefono, email)"+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
